...
class File:
    ...
    def read_data(self):
        ...
        # replace jest konieczny, aby pierwsza wiadomość nie była uznana za ast.Junk
...
class FluentFile(File):
    ...
    def parse_data(self, file_data: typing.AnyStr):
        ...
        for body_element in parsed_data.body:
            ...
            if not body_element.value or not hasattr(body_element.value, 'elements'):
                continue
...
class YAMLFile(File):
    ...
    def get_elements(self, parsed_data):
        ...
        if isinstance(parsed_data, list):
            ...
            # element może być None, jeśli ma nieznany typ
