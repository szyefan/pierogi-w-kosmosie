...
class FluentSerializedMessage:
    ...
    def from_lokalise_keys(cls, keys: typing.List[LokaliseKey]):
        ...
        for key in keys:
            ...
            key_value = key.get_translation('pl').data['translation']
            key_attributes = []
            ...
            if full_message:
                ...
                raise Exception('Nie można utworzyć serializowanej wiadomości dla klucza {key}'.format(key=key.key_name))
    ...
    def get_attr(k, name, parent_id = None):
        if parent_id:
            ...
            return k.get_translation('pl').data['translation']
