...
ent-DrinkHakkaMateCan = hakka mate can
    .desc = A bright orange can of hakka mate, a form of yerba-mate soda popular on mars!
ent-DrinkMelonSodaCan = katsuga melon soda can
    .desc = A can of katsuna melon soda. Has the distinct taste of melon and soda, unsurprisingly.
ent-Drink24VoltEnergySodaCan = 24 Volt Energy can
    .desc = A can of 24 volt energy. Has a certain battery-acid taste to it which can't be beat.
