...
ent-ClothingOuterRobesBloodCult = bloodcult robes
    .desc = An evil-looking cloth robe, dripping with blood and reinforced with armor plates, with an attached hood.
...
ent-ClothingOuterVestArmorMedSec = kamizelka ochronna medyka ochrony
    .desc = Kamizelka ochronna medyka ochrony, z małymi kieszonkami na drobiazgi.
