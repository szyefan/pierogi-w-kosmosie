...
# Caller ID
chat-telephone-unknown-caller = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Nieznany numer[/bolditalic][/font][/color]
...
chat-telephone-unknown-device = [color={$color}][font={$fontType} size={$fontSize}][bolditalic]Nieznane urządzenie[/bolditalic][/font][/color]
