...
alerts-knockdown-name = [color=yellow]Przewrócony[/color]
alerts-knockdown-desc = Jesteś [color=yellow]Przewrócony[/color]! Coś cię popchnęło lub straciłeś równowagę, ograniczając twoje ruchy.
