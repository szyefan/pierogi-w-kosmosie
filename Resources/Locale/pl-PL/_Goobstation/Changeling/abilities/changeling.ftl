...
changeling-absorb-start = { CAPITALIZE($user) } starts absorbing { CAPITALIZE($target) }'s!
...
changeling-transform-others = { CAPITALIZE($user) }'s body twists and takes shape of another being!
...
changeling-sting-fail-self = You tried to sting { CAPITALIZE($target) }, but something stopped you from doing it!
changeling-sting-fail-ling = Someone just tried to silently sting you!
changeling-sting = You silently sting { CAPITALIZE($target) }
