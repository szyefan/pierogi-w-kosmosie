...
contraband-examine-text-Highly-Illegal =
    { $type ->
       *[item] [color=crimson]Ten przedmiot stanowi wysoce nielegalną kontrabandę![/color]
        [reagent] [color=crimson]Ten reagent stanowi wysoce nielegalną kontrabandę![/color]
    }
