...
injector-component-target-already-full-message = { CAPITALIZE($target) } is already full!
injector-component-target-is-empty-message = { CAPITALIZE($target) } is empty!
...
injector-component-drawing-target = { CAPITALIZE($user) } is trying to use a needle to draw from you!
injector-component-injecting-target = { CAPITALIZE($user) } is trying to inject a needle into you!
