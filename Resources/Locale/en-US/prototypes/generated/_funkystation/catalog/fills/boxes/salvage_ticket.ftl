ent-BoxSalvageVendShuttleKit = shuttle board kit
    .desc = A box filled with all the necessary boards needed to create a new shuttle, or repair an existing one. You didn't crash into something, right?
