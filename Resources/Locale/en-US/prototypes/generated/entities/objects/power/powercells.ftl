...
ent-PowerCellMediumSingle = medium-capacity single-use power cell
    .desc = An unrechargeable power cell. This is the popular and cheap version. The cell isn't worth the time it takes to throw it away.
    .suffix = Full, Single Use
ent-PowerCellHighSingle = high-capacity single-use power cell
    .desc = An unrechargeable standardized power cell. This subpar brand stores up to 50% more energy than the competition with cost cutting measures to compensate.
    .suffix = Full, Single Use
ent-PowerCellHyperSingle = hyper-capacity single-use power cell
    .desc = An unrechargeable standardized power cell. This one looks like an imitation of a prototype.
    .suffix = Full, Single Use
