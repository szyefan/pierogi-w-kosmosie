...
ent-WeaponLaserGun = retro laser blaster
    .desc = An older model of the now defunct line of the sectech™ laser blaster. Rumors say it went defunct after a incident when a cadet misfired and melted a centcomm offical's brain.
...
ent-WeaponLaserCarbinePractice = practice laser bolt carbine
    .desc = This modified carbine rifle fires nearly harmless bolts in the 40-watt range, for target practice.
ent-WeaponLaserCarbine = laser bolt carbine
