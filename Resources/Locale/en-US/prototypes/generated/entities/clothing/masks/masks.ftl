...
ent-ClothingMaskGasExplorer = explorers reinforced gas mask
    .desc = A gas mask with reinforced padding for wildlife encounters, can be connected to an air supply.
ent-ClothingMaskBreathMedical = medical mask
    .desc = A close-fitting sterile mask that can be connected to an air supply.
ent-ClothingMaskBreathMedicalBed = { ent-ClothingMaskBreathMedical }
    .desc = A close-fitting sterile mask that can be connected to an air supply. This one is attached to the medical bed's internals system.
    .suffix = Unremovable
...
ent-ClothingMaskGasMerc = mercenary armored gas mask
    .desc = A reliable military-style gas mask built for heavy combat, can be connected to an air supply.
