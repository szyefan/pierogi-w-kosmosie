...
ent-ClothingOuterCoatLab = medical lab coat
    .desc = A medical-grade labcoat that protects against minor chemical spills. Makes you about 15% more trustworthy.
ent-ClothingOuterCoatLabOpened = medical lab coat
    .desc = { ent-ClothingOuterStorageFoldableBaseOpened.desc }
ent-ClothingOuterCoatLabChem = chemist lab coat
    .desc = A labcoat made of an acid-resistant blend of three types of synthetic fiber. Won't protect you from an explosion, though.
...
ent-ClothingOuterCoatLabCmo = chief medical officer's lab coat
    .desc = Custom made lab coat for the Chief Medical Officer, offers improved protection against chemical spills and minor cuts.
